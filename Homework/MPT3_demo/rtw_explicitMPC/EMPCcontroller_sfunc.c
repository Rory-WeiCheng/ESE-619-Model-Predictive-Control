...
/* Generated on 20-Jan-2023 17:25:14 by MPT @version@ */ 

#define S_FUNCTION_NAME  EMPCcontroller_sfunc   /*Name of the S-function file*/
#define S_FUNCTION_LEVEL 2		/*Level 2 S-functions allow multi-port status*/
#define MPT_TS 1.000000		/* sample time */
#include "simstruc.h"			/*Header where different routines are defined */

#include "EMPCcontroller.c" /*inclusion of the evalution algorithm */
